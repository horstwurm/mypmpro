...
def init_apps
  ...
  if !apps or apps.count==0
    ...
    @array << hash
    hash = Hash.new
    hash = {"domain" => "hauptmenue", "right" => "sensoren", "access" => true, "info" => "payable", "fee" => 500}
    @array << hash
    hash = Hash.new
    ...
    @array << hash
    hash = Hash.new
    hash = {"domain" => "personen", "right" => "veranstaltungen", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    hash = {"domain" => "personen", "right" => "sensoren", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    hash = {"domain" => "personen", "right" => "anmeldungen", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    hash = {"domain" => "personen", "right" => "tickets", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    ...
    @array << hash
    hash = Hash.new
    hash = {"domain" => "institutionen", "right" => "veranstaltungen", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    hash = {"domain" => "institutionen", "right" => "sponsorenengagements", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    ...
    @array << hash
    hash = Hash.new
    hash = {"domain" => "objekte", "right" => "eintrittskarten", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    hash = {"domain" => "objekte", "right" => "sponsorenengagements", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    ...
    @array << hash
    hash = Hash.new
    hash = {"domain" => "objekte", "right" => "kalendervermietungen", "access" => false, "info" => "news"}
    @array << hash
    hash = Hash.new
    hash = {"domain" => "objekte", "right" => "teilnehmerveranstaltung", "access" => true, "info" => "news"}
    @array << hash
    hash = Hash.new
    ...
    @array << hash
    hash = Hash.new
    hash = {"domain" => "objekte", "right" => "artikel", "access" => false, "info" => "news"}
    @array << hash
